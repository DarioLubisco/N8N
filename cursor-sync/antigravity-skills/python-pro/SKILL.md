...
- Configuration management and environment variables: NEVER hardcode connection strings, IPs, or credentials in scripts. Always use `.env` files and `python-dotenv` for infrastructure decoupling.
